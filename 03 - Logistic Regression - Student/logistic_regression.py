...
class LogisticRegression(object):
    ...
    def initialize_weights(self, dim, std_dev=1e-2):
        ...
        self.params = {}
        #############################################################################
        # TODO: Initialize the weight vector and bias to random values with         #
    ...
    def sigmoid(self,z):
        ...
        Inputs:
        - z: (float) Any scalar/vector/matrix.
    ...
    def loss(self, X, y=None, reg=0.0):
        ...
        #############################################################################
        loss = self.binary_cross_entropy(probs, y) + (reg*0.5)*np.sum(np.square(W)) 
        #############################################################################
        #                              END OF YOUR CODE                             #
        #############################################################################
        ...
        grads['W'] = np.dot(X.T,(y - probs))/N + reg*W
